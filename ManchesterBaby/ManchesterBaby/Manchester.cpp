...
int main() {
    std::string programFile; // To hold the program filename

    // Prompt user to input the program file name
    ...
    manchesterBaby.loadProgram(programFile); // Load the specified program file
...
void ManchesterBaby::loadProgram(const std::string& filename) {
    ...
    if (std::getline(file, temp)) {
        // Successfully read and ignored the first line
    }
